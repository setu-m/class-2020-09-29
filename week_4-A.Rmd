...
d_2018 <- read_enrollment(file = "raw_data/class_enrollment_summary_by_term_10.24.18.xlsx", x = 2)
...
```{r}
comb_year <- bind_rows(list(d_2019, d_2018, d_2017, d_2016, d_2015), .id = "year") %>%
